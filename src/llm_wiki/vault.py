...
class Vault:
    ...
    def scan(cls, root: Path, config: WikiConfig | None = None) -> Vault:
        ...
        md_files = [
            ...
            # index.md is auto-generated by the librarian; exclude it from the
            # content graph so it never appears as an orphan or skews page counts.
            # Use relative path to avoid excluding nested index.md files.
